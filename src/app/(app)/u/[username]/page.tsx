...
export default function Page() {
  ...
  return (
    <div className="i-fonts w-9/12 mx-auto flex flex-col mt-24 mb-6 text-i-white font-serif font-normal gap-4">
        ...
        {/* main heading */}
        <h1 className="text-4xl mx-auto font-bold text-[#f5f5f7e4]">Public Profile Link</h1>
        ...
        <div className="mt-4 flex flex-col gap-2 i-fonts">
          ...
          {/* heading */}
          <p className="ml-2 text-i-white/90">Click on any message below to select it.</p>

          <div className = "flex flex-col gap-3 bg-white/4 border border-white/8 rounded-2xl px-5 py-4 backdrop-blur-xl shadow-[0_2px_16px_rgba(0,0,0,0.3),inset_0_0_0_0.5px_rgba(255,255,255,0.04)] w-11/12">
